  ...
  return (
    ...
    <div className="intro">
      ...
      <p>Estos ciclos pueden tener diferentes duraciones, y en intervalos temporales prolongados, suelen ser más fiables.
        ...
        Solo después de que una parte del ciclo haya concluido se puede realizar un análisis más preciso. Además, los ciclos de mercado raramente presentan puntos de inicio y final concretos, lo que dificulta aún más su identificación.
        <ul>
          <li>Expansión: esta es la fase en la que los precios de los activos suben. Esto suele ser causado por un crecimiento económico fuerte, tasas de interés bajas y un aumento de la confianza de los inversores.
          </li>
          <li>Pico: esta es la fase en la que los precios de los activos alcanzan su punto máximo. Esto suele ser causado por el exceso de confianza de los inversores y la especulación.</li>
          <li>Recesión: esta es la fase en la que los precios de los activos bajan. Esto suele ser causado por una desaceleración económica, tasas de interés más altas y una pérdida de confianza de los inversores.</li>
          <li>Fondo: esta es la fase en la que los precios de los activos alcanzan su punto más bajo. Esto suele ser causado por un pánico de los inversores y una venta masiva.</li>
        </ul></p>
    </div>
